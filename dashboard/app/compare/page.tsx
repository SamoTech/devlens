  ...
  return (
    <div style={{ padding:"var(--space-12) var(--space-6)" }}>
      <div style={{ maxWidth:"900px",margin:"0 auto",display:"flex",flexDirection:"column",gap:"var(--space-8)" }}>
        <div>
          <h1 style={{ fontFamily:"var(--font-display)",fontSize:"var(--text-xl)",fontWeight:800,marginBottom:"var(--space-2)" }}>Compare Repos</h1>
          <p style={{ color:"var(--text-muted)",fontSize:"var(--text-sm)" }}>Analyze two repositories side by side across all 7 health dimensions.</p>
        </div>

...
import { DIMMETA, badgeColor, scoreLabel } from '@/lib/constants'
          ...
          {report && (
            <>
              ...
              {report.suggestions.length > 0 && (
                <div style={{ background: 'var(--warning-hl, #fffbe6)', border: '1px solid var(--border)', borderRadius: 'var(--radius-xl)', padding: 'var(--space-6)' }}>
